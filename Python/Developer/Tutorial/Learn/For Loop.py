...
# For Loop: One Line
strings_list = [s for s in string.ascii_uppercase]
strings_set = {s for s in string.ascii_uppercase}
strings_tuple = (s for s in string.ascii_uppercase)
print(strings_list)
print(strings_set)
print(*[t for t in strings_tuple])
